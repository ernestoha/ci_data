...
*/
$config['tables']['users']           = 'ci_ia_users';
$config['tables']['groups']          = 'ci_ia_groups';
$config['tables']['users_groups']    = 'ci_ia_users_groups';
$config['tables']['login_attempts']  = 'ci_ia_login_attempts';
